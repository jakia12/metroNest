...
const testimonials = [
  {
    ...
    name: "Julia Era",
    role: "Property owner",
    avatar: "/images/julia.png", // put your image here
    text: "Tenax comitatus ambulo regnum eligo, conturbo vis caelum cohors. Infit ustulo adoptio collum, speciosus lumen soluta. Condico spiculum ratio, sopor conventus adversus fiducia. Arma accesso altaria impleo pax laboriosus.",
    rating: 5,
  },
  {
    id: 2,
    ...
    text: "Tempus appono validus translatio. Exemplum adnuo sponte voluntas radius caecus exsisto. Cedo umquam cedo summisse damnum reiciendis veritas flamma.",
    rating: 5,
  },
];
            ...
            {testimonials.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="flex flex-col items-center">
                  ...
                  {/* Text */}
                  <p className="max-w-4xl text-sm font-medium leading-relaxed text-slate-900 sm:text-base md:text-[15px]">
                    “{item.text}”
                  </p>
